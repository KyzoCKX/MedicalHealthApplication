...
class LoginUserWidget extends StatefulWidget {
  ...
  static String routePath = '/loginUser';
...
class _LoginUserWidgetState extends State<LoginUserWidget>
  ...
  void initState() {
    ...
    _model.passwordsCreateTextController ??= TextEditingController();
    _model.passwordsCreateFocusNode ??= FocusNode();
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .passwordsCreateTextController,
                                                focusNode: _model
                                                    .passwordsCreateFocusNode,
                                                autofocus: true,
                                                autofillHints: [
                                                  AutofillHints.password
                                                ],
                                                obscureText: !_model
                                                    .passwordsCreateVisibility,
                                                decoration: InputDecoration(
                                                  labelText: 'Password',
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                  ...
                                                  suffixIcon: InkWell(
                                                    ...
                                                    focusNode: FocusNode(
                                                        skipTraversal: true),
                                                    child: Icon(
                                                      _model.passwordsCreateVisibility
                                                          ? Icons
                                                              .visibility_outlined
                                                          : Icons
                                                ...
                                                onPressed: () async {
                                                  ...
                                                  if (_model
                                                    ...
                                                    if (_model
                                                            .roledropdownValue ==
                                                        'Therapist') {
                                                      await TherapistRecord
                                                          .collection
                                                          .doc()
                                                          .set(
                                                              createTherapistRecordData(
                                                            name: '',
                                                            email: '',
                                                            displayName: '',
                                                            photoUrl: '',
                                                      ...
                                                      if (_model
                                                              .roledropdownValue ==
                                                          'User') {
                                                        await MentalStatusesRecord
                                                            .collection
                                                            .doc()
                                                            .set({
                                                          ...createMentalStatusesRecordData(
                                                            userRef:
