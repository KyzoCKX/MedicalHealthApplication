...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: LoginUserWidget.routeName,
          path: LoginUserWidget.routePath,
        ...
        FFRoute(
          name: ForgotPasswordsWidget.routeName,
          path: ForgotPasswordsWidget.routePath,
          builder: (context, params) => ForgotPasswordsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: TherapistMenuWidget.routeName,
          path: TherapistMenuWidget.routePath,
          builder: (context, params) => TherapistMenuWidget(),
        ),
        FFRoute(
          name: EmotionListWidget.routeName,
          path: EmotionListWidget.routePath,
          builder: (context, params) => EmotionListWidget(),
        ),
        FFRoute(
          name: QuestionListWidget.routeName,
          path: QuestionListWidget.routePath,
          asyncParams: {
        ...
        FFRoute(
          name: CreateEmotionQWidget.routeName,
          path: CreateEmotionQWidget.routePath,
          builder: (context, params) => CreateEmotionQWidget(),
        ),
        FFRoute(
          name: ListQuizWidget.routeName,
          path: ListQuizWidget.routePath,
          builder: (context, params) => ListQuizWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: Quiz1pageWidget.routeName,
          path: Quiz1pageWidget.routePath,
          asyncParams: {
            'quizRef': getDoc(['Quizzes'], QuizzesRecord.fromSnapshot),
          },
          builder: (context, params) => Quiz1pageWidget(
            quizRef: params.getParam(
              'quizRef',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: TherapistProfileWidget.routeName,
          path: TherapistProfileWidget.routePath,
          builder: (context, params) => TherapistProfileWidget(),
        ),
        FFRoute(
          name: ListQuestionsWidget.routeName,
          path: ListQuestionsWidget.routePath,
