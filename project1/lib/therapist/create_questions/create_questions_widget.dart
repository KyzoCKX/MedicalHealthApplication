            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              25.0, 0.0, 25.0, 0.0),
                          child: Text(
                            'Enter a yes/no kind questiond below and add the question options. Once options are added, select the positive option for the use of user statistics.',
                          ...
                          children: [
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Type question options here',
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: 'Plus Jakarta Sans',
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.addToQuestionOptions(OptionsStruct(
                                    optionName: _model.textController2.text,
                                  ));
                                  safeSetState(() {});
                                  safeSetState(() {
                  ...
                  Builder(
                    builder: (context) {
                      final options = _model.questionOptions.toList();
                        ...
                        itemBuilder: (context, optionsIndex) {
                          ...
                          return Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                _model.addPoints = optionsItem.optionName;
                                safeSetState(() {});
                              },
                              child: Container(
                                width: 100.0,
                                ...
                                decoration: BoxDecoration(
                                  color:
                                      optionsItem.optionName == _model.addPoints
                                          ? FlutterFlowTheme.of(context).primary
                                      ...
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              _model.removeFromQuestionOptions(
                                                  optionsItem);
                                              safeSetState(() {});
                                            },
                                            child: Icon(
                                ...
                                ...mapToFirestore(
                                  {
                                    'listQuestions': FieldValue.arrayUnion(
                                        [_model.questions?.reference]),
                                    'numQuestions': FieldValue.increment(1),
                                  },
                                ),
                              });
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  ...
                                  'index': serializeParam(
                                    functions.indexIncrease(widget.index),
                                    ParamType.int,
                                  ),
                                }.withoutNulls,
