                        ...
                        StreamBuilder<List<MentalStatusesRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<MentalStatusesRecord>
                                chartMentalStatusesRecordList = snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final chartMentalStatusesRecord =
                                chartMentalStatusesRecordList.isNotEmpty
                                    ? chartMentalStatusesRecordList.first
                                    : null;
                            ...
                            return Container(
                              ...
                              child: FlutterFlowBarChart(
                                barData: [
                                  FFBarChartData(
                                    yData: chartMentalStatusesRecord!.score,
                                    color: FlutterFlowTheme.of(context).primary,
                                  )
                                ],
                                xLabels: chartMentalStatusesRecord.date
                                    .map((e) => e.toString())
                                    .toList(),
                                barWidth: 16.0,
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'The mental health and emotion are stable',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'The mental health and emotional is not quite stable',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
